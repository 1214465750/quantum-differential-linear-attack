...
if __name__=='__main__':
    ...
    ax = axs[0, 0]
    list_cor = np.load('simeck_right_0x4000_0xe008_0x200_0x100_R9_N20_NK15_DKP.npy').tolist()
    NK = list_cor[-1]
    N = list_cor[-2]
    elp = list_cor[-3]
    list_cor = list_cor[:-3]
    ...
    name = 'correct guessing key,' + r'$\left( \left( 0x4000,0xe008 \right)\to \left( 0x200,0x100 \right) \right)$ '
    ...
    ax = axs[0, 1]
    list_cor = np.load('simeck_right_0x8000_0x11_0x80_0x140_R9_N20_NK15_DKP.npy').tolist()
    NK = list_cor[-1]
    N = list_cor[-2]
    elp = list_cor[-3]
    list_cor = list_cor[:-3]
    ...
    # 设置标题、标签等 - 使用ax.set_title, ax.set_xlabel等
    name = 'correct guessing key,' + r'$\left( \left( 0x8000,0x11 \right)\to \left( 0x80,0x140 \right) \right)$ '
    ax.set_title(name, fontsize=14)
    ax.set_xlabel('Experimental correlation', fontsize=12)
    ax.set_ylabel('Probability density', fontsize=12)
    ax.legend(fontsize=8)
    ...
    ax = axs[1, 0]
    list_cor = np.load('simeck_wrong_0x4000_0xe008_0x200_0x100_R9_RW4_N20_NK15_DKP.npy').tolist()
    NK = list_cor[-1]
    N = list_cor[-2]
    elp = list_cor[-3]
    list_cor = list_cor[:-3]
    ...
    # 设置标题、标签等 - 使用ax.set_title, ax.set_xlabel等
    name = 'incorrect guessing key,' + r'$\left( \left( 0x4000,0xe008 \right)\to \left( 0x200,0x100 \right) \right)$ '
    ax.set_title(name, fontsize=14)
    ax.set_xlabel('Experimental correlation', fontsize=12)
    ax.set_ylabel('Probability density', fontsize=12)
    ax.legend(fontsize=8)
    ...
    ax = axs[1, 1]
    list_cor = np.load('simeck_wrong_0x8000_0x11_0x80_0x140_R9_RW4_N20_NK15_DKP.npy').tolist()
    NK = list_cor[-1]
    N = list_cor[-2]
    elp = list_cor[-3]
    list_cor = list_cor[:-3]
    ...
    # 设置标题、标签等 - 使用ax.set_title, ax.set_xlabel等
    name = 'incorrect guessing key,' + r'$\left( \left( 0x8000,0x11 \right)\to \left( 0x80,0x140 \right) \right)$ '
    ax.set_title(name, fontsize=14)
    ax.set_xlabel('Experimental correlation', fontsize=12)
    ax.set_ylabel('Probability density', fontsize=12)
    ax.legend(fontsize=8)
    ...
    # fig.tight_layout()
    # fig.suptitle(r'Simeck32/64差分-线性区分器正确和incorrect guessing key的实验相关性统计',
    #              fontsize=16,  # 字体大小
    #              fontweight='bold',  # 加粗
    #              y=0.95,  # 垂直位置（0-1，默认0.98）
    #              x=0.5,  # 水平位置（0-1，默认0.5居中）
    #              ha='center')

    plt.show()


    out_dir2 = r'D:\学生\马成栋\我的论文\量子差分线性攻击\图片\Simeck32_64差分-线性区分器正确和incorrect guessing key的实验相关性.png'
